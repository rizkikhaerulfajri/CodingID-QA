...
Mobile.waitForElementPresent(findTestObject('Android/EditProfile_ErrorMsg_WhatsApp number is required_Field_Phone'), 0, FailureHandling.CONTINUE_ON_FAILURE)
