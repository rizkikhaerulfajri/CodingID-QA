...
Mobile.setEncryptedText(findTestObject('Android/Login_Field_Password'), 'qsMa34VCJB3iRZrQ7Ygp+A==', 0)

Mobile.switchToNative()

Mobile.tap(findTestObject('Android/Login_Button_Login'), 0)

Mobile.waitForElementPresent(findTestObject('Android/Login_ErrorMsg_InvalidCredentials'), 0)

Mobile.tap(findTestObject('Android/Login_ErrorMsg_InvalidCredentials_BtnOk'), 0)
