...
Mobile.setText(findTestObject('Android/Register_Field_Nama'), 'Apa aja', 0)

Mobile.setText(findTestObject('Android/Register_Field_Nama'), '', 0)

Mobile.verifyElementVisible(findTestObject('Android/Register_ErrorMsg_NameCantBeEmpty_Field_Nama'), 2, FailureHandling.STOP_ON_FAILURE)

Mobile.verifyElementNotVisible(findTestObject('Android/Register_ErrorMsg_NameMustBeAlphabethic_Field_Nama'), 2, FailureHandling.STOP_ON_FAILURE)
