...
Mobile.verifyElementNotVisible(findTestObject('Android/Register_ErrorMsg_Email cant be empty_Field_Email'), 2)

Mobile.verifyElementNotVisible(findTestObject('Android/Register_ErrorMsg_Format Email is Not Valid_Field_Email'), 2)
