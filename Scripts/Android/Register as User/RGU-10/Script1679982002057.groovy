...
Mobile.setText(findTestObject('Android/Register_Field_Email'), '', 0)

Mobile.verifyElementVisible(findTestObject('Android/Register_ErrorMsg_Email cant be empty_Field_Email'), 5)

Mobile.verifyElementNotVisible(findTestObject('Android/Register_ErrorMsg_Format Email is Not Valid_Field_Email'), 5)
