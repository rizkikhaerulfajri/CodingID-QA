...
Mobile.setText(findTestObject('Android/Register_Field_Email'), 'dumpatmaildotcom', 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.setText(findTestObject('Android/Register_Field_Email'), '', 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyElementVisible(findTestObject('Android/Register_ErrorMsg_Email cant be empty_Field_Email'), 3)

Mobile.verifyElementNotVisible(findTestObject('Android/Register_ErrorMsg_Format Email is Not Valid_Field_Email'), 3)
