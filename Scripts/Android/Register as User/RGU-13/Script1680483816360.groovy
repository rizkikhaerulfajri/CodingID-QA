...
Mobile.setText(findTestObject('Android/Register_Field_WhatsApp'), 'a', 0)

Mobile.waitForElementPresent(findTestObject('Android/Register_ErrorMsg_WhatsApp number is require_Field_WhatsApp'), 3, FailureHandling.CONTINUE_ON_FAILURE)
