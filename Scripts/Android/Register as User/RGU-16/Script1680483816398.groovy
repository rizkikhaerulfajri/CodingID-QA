...
Mobile.setText(findTestObject('Android/Register_Field_KataSandi'), ' ', 0)

Mobile.clearText(findTestObject('Android/Register_Field_KataSandi'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.waitForElementPresent(findTestObject('Android/Register_ErrorMsg_Password atleast must contain_Field_KataSandi'), 
