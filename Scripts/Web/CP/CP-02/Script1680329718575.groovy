...
assert WebUI.verifyElementNotPresent(findTestObject('Object Repository/WEB/Change Profile/Profile_p_ChangeSuccessNotif'), 
    2) : 'Profile was updated, not cancelled'
