	...
	//To reduce looping time, set the year to 2015
	WebUI.setText(findTestObject('WEB/Change Profile/ChangeProfile_inputText_BirthDay'), '01-Jan-2015')
	
	while(WebUI.verifyElementPresent(findTestObject('WEB/Change Profile/ChangeProfile_Calendar_nextButton'), 0, FailureHandling.OPTIONAL)) {
		WebUI.click(findTestObject('WEB/Change Profile/ChangeProfile_Calendar_nextButton'))
	}
	WebUI.click(findTestObject('WEB/Change Profile/ChangeProfile_Calendar_SelectedDateFirstRow'))
