...
WebUI.setText(findTestObject('Object Repository/Web/Register/Reg_InputText_Nama'), 'Rizki Khaerul')
...
//Verify Login Token doesn't exist
def emailConfirm = WebUI.executeJavaScript('return mail;', null)

assert emailConfirm == null : 'Login token should not exists'
