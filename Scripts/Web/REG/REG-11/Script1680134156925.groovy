...
// Load test data
def testData = TestDataFactory.findTestData("Data Files/Web/Register_Name")

for (def i = 1; i <= testData.getRowNumbers(); i++) {
	def name = testData.getValue("Name", i)
	WebUI.navigateToUrl('https://demo-app.online/daftar')
	
	WebUI.setText(findTestObject('Object Repository/Web/Register/Reg_InputText_Nama'), name)
