...
WebUI.setText(findTestObject('Object Repository/Web/Register/Reg_InputText_BirthDay'), '01-Jan-2023')
...
assert WebUI.getUrl() == 'https://demo-app.online/email/verify' : 'Register process stopped'
