...
WebUI.setText(findTestObject('Object Repository/Web/Register/Reg_InputText_BirthDay'), '01-Jan-2020')
...
def expectedInputBirthday = '01-Jan-2020'
...
assert years >= 6 : "The input date is not younger than 100 years."
