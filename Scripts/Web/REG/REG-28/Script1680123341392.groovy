...
// Load test data
def testData = TestDataFactory.findTestData("Data Files/Web/Register_InvalidEmail")

boolean hasError = true

for (def i = 1; i <= testData.getRowNumbers(); i++) {
	def email = testData.getValue("E-mail", i)
	...
	WebUI.setText(findTestObject('Object Repository/Web/Register/Reg_InputText_Email'), email)
