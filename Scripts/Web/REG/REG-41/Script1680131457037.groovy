...
// Load test data
def testData = TestDataFactory.findTestData("Data Files/Web/Register_PasswordLessChar")
...
for (def i = 1; i <= testData.getRowNumbers(); i++) {
	...
	WebUI.setText(findTestObject('Object Repository/Web/Register/Reg_InputText_KataSandi'), password)
	
	WebUI.setText(findTestObject('Object Repository/Web/Register/Reg_InputText_KonfirmasiKataSandi'), password)
